...
// ─── Brand constants ──────────────────────────────────────────────────────────
const NAME         = "WARREN'S";
const TAGLINE      = "Columbia&apos;s first Black-owned barbershop. The standard hasn&apos;t changed.";
const CITY         = "Columbia, MD";
const PHONE        = "(443) 583-0880";
const PHONE_RAW    = "4435830880";
const BOOKING_URL  = "https://booksy.com";
const IG_HANDLE    = "@warrens_barbershop";
const IG_URL       = "https://instagram.com/warrens_barbershop";
const RATING       = "4.2";
const REVIEW_COUNT = "158";
const EST          = "Columbia's First";
...
const SERVICES = [
  { name: "Classic Cut",     price: "$28", dur: "30 min", desc: "Scissor or clipper cut, finished clean with a straight razor neck shave.",     popular: false },
  { name: "Fade",            price: "$33", dur: "35 min", desc: "High, mid, or low fade tailored to your head shape and style.",               popular: true  },
  { name: "Beard Trim",      price: "$18", dur: "20 min", desc: "Full lineup, shape, and detail with a straight razor edge.",                   popular: false },
  { name: "Kids Cut",        price: "$22", dur: "30 min", desc: "Patient, precise, and friendly. 12 and under.",                               popular: false },
  { name: "Cut + Beard",     price: "$45", dur: "50 min", desc: "Haircut and full beard trim combo — the complete service.",                   popular: false },
  { name: "Hot Towel Shave", price: "$30", dur: "30 min", desc: "Traditional straight razor shave with pre-shave oil and hot towel treatment.", popular: false },
];

const TEAM = [
  { name: "Warren", role: "Owner & Master Barber", spec: "All cuts · 20+ years", bio: "Been cutting in Columbia since before most of our clients were driving. Precision is the standard.", img: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=600&q=80" },
  { name: "Marcus", role: "Senior Barber",          spec: "Fades & specialist cuts",  bio: "Trained under Warren for 6 years. Fades are his specialty — clean lines, every time.",           img: "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=600&q=80" },
  { name: "Jordan", role: "Barber",                 spec: "Classic cuts & lineups",   bio: "New to the chair, old-school about the craft. Fresh talent, proven technique.",                   img: "https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?w=600&q=80" },
];

const REVIEWS = [
  { text: "Best fades in Columbia, period. Been coming here for 6 years and Warren never misses. You show up, you leave looking right.", name: "James T.", sub: "Regular" },
  { text: "Took my son here for his first real haircut. Patient, professional, and the cut was perfect. We'll be back every month.", name: "David M.", sub: "Kids Cut" },
  { text: "This shop has history. Real barbers, real craft. Don't sleep on Warren's — it's the kind of place you feel lucky to know about.", name: "Marcus L.", sub: "Regular" },
  { text: "158 reviews at 4.2 stars isn't an accident. Consistency is the thing here. Warren's delivered every single time.", name: "Andre P.", sub: "Regular" },
];
...
const PILLARS = [
  { title: "Columbia's First", desc: "The original Black-owned barbershop in Columbia — and still the standard." },
  { title: "Precision Craft",  desc: "Every fade, taper, and lineup finished the way it should be." },
  { title: "158 Reviews",      desc: "Four point two stars built on consistency, not marketing." },
];
    ...
    <div style={{ background: BG1, color: "#fff", fontFamily: "var(--font-inter)" }}>
      ...
      <section className="relative w-full flex items-center justify-center overflow-hidden" style={{ minHeight: "100vh" }}>
        <div className="absolute inset-0">
          <Image fill sizes="100vw" src="https://images.unsplash.com/photo-1503951914875-452162b0f3f1?w=1920&q=80" alt="Warren's Barber Shop" className="object-cover" />
          <div className="absolute inset-0" style={{ background: "linear-gradient(to right,rgba(10,10,10,.88) 40%,rgba(10,10,10,.45) 100%)" }} />
        ...
        <div className="relative z-10 text-center px-4 max-w-5xl mx-auto" style={{ paddingTop: 100 }}>
          ...
          <p className="mt-3 text-base md:text-lg max-w-xl mx-auto leading-relaxed" style={{ color: T2 }}>
            Columbia&apos;s first Black-owned barbershop. The standard hasn&apos;t changed.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center mt-10">
            <a href={BOOKING_URL} target="_blank" rel="noopener noreferrer"
              className="text-[11px] font-bold tracking-[0.25em] uppercase px-10 py-4 transition-opacity hover:opacity-90"
              style={{ background: ACCENT, color: "#0A0A0A" }}>
              Book Your Cut
            </a>
            <a href="#team"
          ...
          <div className="mt-14 flex items-center justify-center gap-8 flex-wrap">
            ...
            <div className="text-center">
              ...
              <div className="text-[10px] tracking-widest uppercase mt-1" style={{ color: T3 }}>In Columbia</div>
            </div>
            <div style={{ width: 1, height: 32, background: BORDER }} />
            <div className="text-center">
      ...
      <section id="services" className="px-4 py-24" style={{ background: BG1 }}>
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="mt-4 text-sm leading-relaxed max-w-xl mx-auto" style={{ color: T2 }}>Transparent pricing, premium work. No surprises when you sit down.</p>
          </div>
      ...
      <section id="team" className="px-4 py-24" style={{ background: BG2, borderTop: `1px solid ${BORDER}` }}>
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="mt-4 text-sm leading-relaxed max-w-xl mx-auto" style={{ color: T2 }}>Skilled hands. Sharp eyes. Zero compromises.</p>
          </div>
      ...
      <section id="gallery" className="px-4 py-24" style={{ background: BG2, borderTop: `1px solid ${BORDER}` }}>
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="mt-4 text-sm" style={{ color: T2 }}>Every cut tells a story. This is our portfolio.</p>
          </div>
          <div className="columns-2 md:columns-3 gap-3 space-y-3">
            {GALLERY.map((src, i) => (
              <div key={i} className="bs-gi relative overflow-hidden break-inside-avoid cursor-pointer"
                ...
                <div className="bs-go absolute inset-0 flex items-center justify-center" style={{ background: `${ACCENT}BB` }}>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 border" style={{ borderColor: BORDER }}>
            <div className="relative min-h-[400px]" style={{ background: BG3 }}>
              <Image fill sizes="(max-width:1024px) 100vw, 50vw" src="https://images.unsplash.com/photo-1521590832167-7bcbfaa6381f?w=900&q=80" alt="Warren's interior" className="object-cover" />
            ...
            <div className="p-8 lg:p-12 border-t lg:border-t-0 lg:border-l" style={{ background: BG2, borderColor: BORDER }}>
              <div className="mb-8">
                ...
                <p className="text-white text-lg leading-relaxed">7290-I Cradlerock Way<br />Columbia, MD 21045</p>
                <a href="https://maps.google.com/?q=Warren%27s+Barber+Shop+Columbia+MD" target="_blank" rel="noopener noreferrer"
              ...
              <div>
                ...
                <a href={BOOKING_URL} target="_blank" rel="noopener noreferrer"
                  className="inline-block text-[11px] font-bold tracking-[0.2em] uppercase px-6 py-3 transition-opacity hover:opacity-90"
                  style={{ background: ACCENT, color: "#0A0A0A" }}>
                  Book an Appointment
                </a>
              </div>
      ...
      <section className="relative overflow-hidden" style={{ background: BG1, padding: "8rem 1rem", borderTop: `1px solid ${BORDER}` }}>
        ...
        <div className="relative max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg md:text-xl mb-12 max-w-xl mx-auto leading-relaxed" style={{ color: T2 }}>
            Walk in confident. Leave looking sharp.
          </p>
          <a href={BOOKING_URL} target="_blank" rel="noopener noreferrer"
        ...
        <div className="max-w-7xl mx-auto px-6 py-16">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            <div>
              ...
              <p className="text-sm leading-relaxed max-w-xs" style={{ color: T2 }}>{CITY}&apos;s original. Precision, community, craft — since day one.</p>
              <a href={IG_URL} target="_blank" rel="noopener noreferrer"
            ...
            <div>
              ...
              <div className="space-y-3">
                <p className="text-sm leading-relaxed" style={{ color: T2 }}>7290-I Cradlerock Way<br />Columbia, MD 21045</p>
          ...
          <div className="mt-12 pt-8 border-t flex flex-col sm:flex-row justify-between items-center gap-4" style={{ borderColor: BORDER }}>
            <p className="text-xs" style={{ color: T3 }}>&copy; 2026 Warren&apos;s Barber Shop. All rights reserved.</p>
