export const metadata = {
  title: "La Perla Barbershop — North Tampa, FL",
  description:
    "The Official La Perla Barbershop LLC — North Tampa's precision barbershop. Bilingual service, two locations on Armenia Ave and Waters Ave. Book online via Booksy.",
};

// ─── Brand constants ───────────────────────────────────────────────────────────
const NAME         = "LA PERLA";
const TAGLINE      = "Precision fades. Honest prices. Your community barbershop — en inglés y en español.";
const CITY         = "Tampa, FL";
const PHONE        = "(813) 280-2199";
const PHONE_RAW    = "8132802199";
const BOOKING_URL  = "https://booksy.com/en-us/483354_the-official-la-perla-barbershop_barber-shop_15761_tampa";
const IG_HANDLE    = "@laperla_barbershop_";
const IG_URL       = "https://www.instagram.com/laperla_barbershop_/";
const RATING       = "4.9";
const REVIEW_COUNT = "303";
const EST          = "La Joya de Armenia Ave · North Tampa";

// Maroon / deep burgundy — La Perla's brand color
const ACCENT       = "#9B2335";
const ACCENT_LIGHT = "#C85070";
...
const SERVICES = [
  {
    ...
    price: "$30",
    dur: "40 min",
    desc: "Skin, low, mid, or high — our signature service. Clean blend, sharp finish, zero steps.",
    popular: true,
  },
  {
    name: "Classic Cut / Corte Clásico",
    price: "$20",
    dur: "15 min",
    desc: "Clean lines, precise clipper work. A timeless cut executed with modern precision.",
    popular: false,
  },
  {
    name: "Blowout",
    price: "$40",
    dur: "30 min",
    desc: "Volume, shape, and texture — the full blowout treatment for curly and wavy hair types.",
    popular: false,
  },
  {
    name: "Hawk / Diseño",
    price: "$40",
    dur: "30 min",
    desc: "Custom hawk cuts and razor-etched designs. Bring your reference or trust our barbers to create.",
    popular: false,
  },
  {
    name: "Beard Trim / Afeitado",
    price: "$15",
    dur: "30 min",
    desc: "Beard shaping, lather shave, and hot towel finish. From a tight lineup to a full-service shave.",
    popular: false,
  },
  {
    name: "Kids Cut / Corte Niños",
    price: "$15",
    dur: "30 min",
    desc: "Patient, friendly barbers who make kids' first haircuts easy. Walk-ins welcome for the little ones.",
    popular: false,
  },
];
...
const TEAM = [
  {
    name: "Jorge",
    role: "Head Barber",
    spec: "Fades · Designs · Blowouts · 8+ yrs",
    bio: "Known for creative fade blends and razor designs, Jorge brings the kind of precision that keeps clients coming back every two weeks. Domina su oficio.",
    img: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=600&q=80",
  },
  {
    name: "Luis",
    role: "Senior Barber",
    spec: "Classic Cuts · Beard Trims · Lather Shaves",
    bio: 'Clients call Luis "by far the best barber" — and he consistently delivers whether it\'s a clean classic taper or a full hot-towel shave. Habla español.',
    img: "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=600&q=80",
  },
  {
    name: "Juan Carlos",
    role: "Barber",
    spec: "Kids Cuts · Hawks · Eyebrows · Detail Work",
    bio: "Noted for patience and precision — Juan Carlos takes his time with the clippers and the result shows. A favorite for kids and clients who want clean detail work.",
...
const REVIEWS = [
  {
    text: "Best barbershop on Armenia Ave, no contest. Jorge does my fade every two weeks and it's always on point. Family vibes, professional results.",
    name: "Marcus T.",
    sub: "Regular · Fade",
  },
  {
    text: "Llevo a mis hijos aquí desde que abrieron. Los barberos son pacientes, profesionales, y el ambiente es como en casa. Siempre salimos contentos.",
    name: "Roberto V.",
    sub: "Regular · Kids Cuts",
  },
  {
    text: "Luis is by far the best barber I've had in Tampa. Clean lines, takes his time, always listens to what you want. 10 out of 10, every single time.",
    name: "Devon A.",
    sub: "Regular · Classic Cut",
  },
  {
    text: "Professional environment, great music, and reasonable prices. Juan Carlos took his time and the detail work was immaculate. This is now my permanent spot.",
    name: "Andres M.",
    sub: "New Client · Hawk + Design",
  },
];
...
const HOURS = [
  { day: "Lun / Monday",          time: "Closed / Cerrado", closed: true  },
  { day: "Mar – Jue / Tue – Thu", time: "10:00 AM – 7:00 PM", closed: false },
  { day: "Vie / Friday",          time: "10:00 AM – 8:00 PM", closed: false },
  { day: "Sáb – Dom / Sat – Sun", time: "10:00 AM – 7:00 PM", closed: false },
];

const PILLARS = [
  {
    title: "Precisión en Cada Corte",
    desc: "Expert barbers trained in the full spectrum — fades, designs, lather shaves, and everything in between.",
  },
  {
    title: "Community First",
    desc: "Rooted in North Tampa's Latin community since day one. Walk-ins welcome. Families always welcome. Tu casa.",
  },
  {
    title: "Precios Honestos",
    desc: "Transparent pricing, no surprises. From a kid's first cut to a full beard lineup — quality you can count on.",
  },
];

// ─── Addresses ────────────────────────────────────────────────────────────────
const ADDRESS_LINE1     = "8311 N Armenia Ave";
const ADDRESS_LINE2     = "Tampa, FL 33604";
const ADDRESS2_LINE1    = "1419 W Waters Ave, Suite 104";
const ADDRESS2_LINE2    = "Tampa, FL 33604";
const MAPS_QUERY        = "The Official La Perla Barbershop Tampa FL";

// ─── Photos ───────────────────────────────────────────────────────────────────
const HERO_PHOTO     = "https://images.unsplash.com/photo-1599351431202-1e0f0137899a?w=1920&q=80";
const LOCATION_PHOTO = "https://images.unsplash.com/photo-1521590832167-7bcbfaa6381f?w=900&q=80";

// ─── Stats ────────────────────────────────────────────────────────────────────
const STAT1_VAL   = "4.9 ★";
const STAT1_LABEL = "303 Google Reviews";
const STAT2_VAL   = "5.0 ★";
const STAT2_LABEL = "1,140 Booksy Reviews";
const STAT3_VAL   = "2";
const STAT3_LABEL = "Tampa Locations";

// ─── Final CTA ────────────────────────────────────────────────────────────────
const CTA_HEADLINE = "Your Chair Is Waiting";
const CTA_BODY     = "Walk in confident. Leave looking sharp. La Perla — donde el corte perfecto es la norma, no la excepción.";
  ...
  return (
    <div style={{ background: BG1, color: "#fff", fontFamily: "var(--font-inter)" }}>
      ...
      <a
        ...
        style={{ background: ACCENT, boxShadow: `0 4px 30px ${ACCENT}72` }}
      >
        Reservar / Book Now
      </a>
      ...
      >
        <div className="absolute inset-0">
          <img
            src={HERO_PHOTO}
            alt="La Perla Barbershop interior"
          ...
          <div
            ...
            style={{
              background:
                "linear-gradient(to bottom,rgba(10,10,10,.72) 0%,rgba(10,10,10,.48) 50%,rgba(10,10,10,.92) 100%)",
            }}
          />
          <div
            className="absolute inset-0"
        ...
        >
          <p
            ...
            style={{ color: ACCENT }}
          >
            Precision Barbershop · Armenia Ave · {CITY}
          </p>
          <h1
          ...
          <p
            className="mt-5 text-sm md:text-base tracking-widest uppercase"
            style={{ color: T2 }}
          >
            {EST}
          </p>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p
              ...
              style={{ color: T2 }}
            >
              Premium services at honest prices. Every cut backed by years of precision craft.
            </p>
          </div>
          <div
          ...
          >
            {SERVICES.map((s) => (
              ...
              >
                {s.popular && (
                  <span
                    className="absolute top-4 right-4 text-[10px] tracking-[0.2em] uppercase px-2 py-0.5 border"
      ...
      {/* LOCATION & HOURS — two locations addressed */}
      <section
        id="visit"
        className="px-4 py-24"
        style={{ background: BG1, borderTop: `1px solid ${BORDER}` }}
      >
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="mt-4 text-sm" style={{ color: T2 }}>
              Two locations serving North Tampa. One standard of excellence.
            </p>
          </div>

          {/* Main location card */}
          <div
            className="grid grid-cols-1 lg:grid-cols-2 border mb-6"
          ...
          >
            ...
            >
              <img
                src={LOCATION_PHOTO}
                alt="La Perla Barbershop Armenia Ave interior"
                className="w-full h-full object-cover absolute inset-0"
              />
              <div
                className="absolute inset-0"
                style={{ background: "rgba(10,10,10,.35)" }}
              />
              {/* Location badge */}
              <div
                className="absolute top-6 left-6 px-3 py-1.5 text-[10px] tracking-[0.2em] uppercase font-bold"
                style={{ background: ACCENT, color: "#fff" }}
              >
                Location 1 — Armenia Ave
              </div>
            </div>
            <div
              className="p-8 lg:p-12 border-t lg:border-t-0 lg:border-l"
            ...
            >
              ...
              >
                <p
                  ...
                  style={{ color: ACCENT }}
                >
                  Segunda Ubicación — Waters Ave
                </p>
                <p className="text-lg leading-relaxed" style={{ color: T2 }}>
                  {ADDRESS2_LINE1}
                  <br />
                  {ADDRESS2_LINE2}
                </p>
                <a
                  href={`https://maps.google.com/?q=${encodeURIComponent("La Perla Barbershop 1419 W Waters Ave Tampa FL")}`}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 mt-4 text-xs tracking-[0.2em] uppercase hover:opacity-70 transition-opacity"
                  style={{ color: T2 }}
                >
                  Directions to Waters Ave
                  <svg
                    className="w-4 h-4"
                    fill="none"
                    stroke="currentColor"
              ...
              <div style={{ borderTop: `1px solid ${BORDER}` }} className="pt-6">
                ...
                <a
                  href={`tel:${PHONE_RAW}`}
                  className="block text-sm hover:text-white transition-colors mb-4"
                  style={{ color: T2 }}
                >
                  {PHONE}
                </a>
      ...
      >
        ...
        <div className="relative max-w-4xl mx-auto text-center px-4">
          ...
          >
            Book Your Appointment / Reservar
          </a>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-6 py-16">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            ...
            <div>
              ...
              <p
                ...
                style={{ color: T2 }}
              >
                North Tampa's precision barbershop. Rooted in the Latin community on Armenia Ave since day one.
              </p>
              <a
                href={IG_URL}
                target="_blank"
            ...
            <div>
              ...
              <ul className="space-y-3">
                {[
                  ...
                  ["#team", "Team / Los Barberos"],
                  ["#gallery", "Gallery / El Trabajo"],
                  ["#visit", "Visit / Visítanos"],
                  [BOOKING_URL, "Book Now / Reservar"],
                ].map(([href, label]) => (
                  <li key={label}>
                    <a
                      href={href}
                      ...
                      style={{
                        color: href === BOOKING_URL ? ACCENT : T2,
                      }}
                    >
                      {label}
                    </a>
          ...
          >
            <p className="text-xs" style={{ color: T3 }}>
              &copy; 2026 The Official La Perla Barbershop LLC. All rights
              reserved.
            </p>
            <p className="text-xs" style={{ color: T3 }}>
              Concept by{" "}
              <span style={{ color: ACCENT }}>Thryve Operations</span>
            </p>
          </div>
        </div>
      </footer>
